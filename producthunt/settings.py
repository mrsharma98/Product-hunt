...
SECRET_KEY = '@_j!1a$@2r+59q!yajvw8mq9!z76eg+=t_bn9u)#ky1cg&z4g)'
...
TEMPLATES = [
    {
        ...
        # if we do not put our template folder inside any apps
        # then we need to mention the path over here.
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
